...
namespace WindowsFormsApp1 {
    ...
    public partial class Form2: Form {
        ...
        [DllImport("Lib2-2-1.dll", EntryPoint = "FuncName", CallingConvention = CallingConvention.StdCall)]
        public static extern IntPtr FuncName1();

        [DllImport("Lib2-2-2.dll", EntryPoint = "FuncName", CallingConvention = CallingConvention.StdCall)]
        public static extern IntPtr FuncName2();

        [DllImport("Lib2-2-3.dll", EntryPoint = "FuncName", CallingConvention = CallingConvention.StdCall)]
        public static extern IntPtr FuncName3();

        [DllImport("MyCppDll.dll", EntryPoint = "FuncName", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr FuncName4();

        [DllImport("MyCDll.dll", EntryPoint = "FuncName", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr FuncName5();

        [DllImport("project1.dll", EntryPoint = "FuncName", CallingConvention = CallingConvention.Cdecl)]
